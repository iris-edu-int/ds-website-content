...
Search using report no. *05-022* or the nickname *SAFOD*. This is the main data set described in the "Readme file":/data/reports/2005/05-022/SAFOD_P-GSI_Readme.pdf. *The total volume exceeds 2 TeraBytes (TB)*, so you may wish to contact the EarthScope DMC first.
