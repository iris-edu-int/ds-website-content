...
_PyWEED_ is a map-based seismogram request tool. It enables the user to select events and stations and then download the data to their computer. PyWEED is platform-independent and allows the user to access information from remote data centers, using the "IRIS Web Services":http://service.iris.edu/. "Read More »":/ds/nodes/dmc/manuals/pyweed/