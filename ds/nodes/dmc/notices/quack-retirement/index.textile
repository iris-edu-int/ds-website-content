...
CRAN repository for the EarthScope metrics API written in R: "$":https://cran.r-project.org/web/packages/IRISMustangMetrics

The helicorder plots are still available at "$":/servlet/webicorder/.

Further information about EarthScope Quality Assurance can be found at "$":/ds/nodes/dmc/quality-assurance/.