...
The submitting data center only need to open a firewall hole to this IRIS DMC machine, and contact "data_submission@iris.washington.edu":mailto:data_submission@iris.washington.edu to initiate submission.
