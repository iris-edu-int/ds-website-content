...
* Contact "data_submission@iris.washington.edu":mailto:data_submission@iris.washington.edu to set up an FTP directory
...
* Before shipping data, contact "data_submission@iris.washington.edu":mailto:data_submission@iris.washington.edu so that we can create the appropriate directories, on the appropriate machine, and permit ftp utilization between data centers.
...
The submitting data center only need to open a firewall hole to this IRIS DMC machine, and contact "data_submission@iris.washington.edu":mailto:data_submission@iris.washington.edu at the IRIS DMC to initiate submission.
