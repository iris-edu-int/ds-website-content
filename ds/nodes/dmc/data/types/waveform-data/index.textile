...
The EarthScope DMC archives waveform ("time-series":/ds/nodes/dmc/data/types/time-series-data/) data from stations around the world. The following information highlights passive and active source data available through the DMC.
...
Simple ASCII is a text column representation timeseries data that EarthScope DMC now provides. This representation makes it very simple to import into other utilities such as spreadsheets and mathematical analysis programs. "More information on the Simple ASCII format &raquo;":/ds/nodes/dmc/data/formats/simple-ascii/
