...
; "Time Series data":/ds/nodes/dmc/data/types/waveform-data/
...
: Includes information such as recording instrument characteristics and data quality; this is generally used to determine the waveform data to request.
...
; "Assembled data":/ds/nodes/dmc/data/types/waveform-data/#assembled
: Discrete collections of waveform data, generally recorded over a period of weeks or months.  Assembled data are often "active source":/ds/nodes/dmc/data/types/waveform-data/#active, meaning that they include artificial seismic events such as explosive blasts intended to seismically map a given region.
