h1. Usage guidelines for EarthScope DMC services

h2. Guidelines for using web services

"Web services":http://service.iris.edu hosted at the EarthScope DMC ("http://service.iris.edu":http://service.iris.edu) should be used with following limitations:
